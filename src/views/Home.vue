<template>
    <Layout>
            ...
            <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                ...
                <a href="#"
                    ...
                    <span class="text-xs bg-primary-600 rounded-full text-white px-4 py-1.5 mr-3">New</span> <span
                        class="text-sm font-medium">Latest version is out! See what's new</span>
                ...
                <h1
                    ...
                    Use AI to analyze your app reviews
                </h1>
                <!-- Hero description -->
                <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">
                    Analyze thousands of reviews using advanced AI to get insights into your app's performance and focus
                    on what matters.
                </p>
                <!-- Hero actions -->
                <div
                    class="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                    <a class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900"
                        href="#">
                        Learn more
        ...
        <!-- <div class="w-full max-w-md p-8 bg-white rounded-lg shadow-md">
            <AnalyzeForm @submit="onSubmit" :loading="isLoading" :error="error" />
        </div> -->
    </Layout>
</template>
...
<script setup>
    ...
    // // define form state
    // const isLoading = computed(() => analysisStore.loading)
    // const error = ref(null)

    // // submit handler
    // const onSubmit = async (appId, count) => {
    //     error.value = null
    //     try {
            
    //         // analyze reviews, skip if analysis already exists
    //         if (!analysisStore.analysisExists(appId)) {
    //             const analysisData = await analysisStore.analyzeAppReviews(appId, count)
    //         }
    ...
    //     } catch (err) {
    //         error.value = `Error: ${err.message || 'Failed to analyze reviews. Please try again.'}`
    //     }
    // }
